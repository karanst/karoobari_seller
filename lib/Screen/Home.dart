...
import 'package:eshopmultivendor/Screen/requests.dart';
  ...
  Future<Null> getRequests() async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        apiBaseHelper.postAPICall(getRequestsApi, parameter).then(
                (getdata) async {
                  ...
                  if (mainList.length != 0) {
                    requestList = (mainList as List)
                        .map((data) => new Data.fromJson(data))
                        .toList();
                    totalRequest = requestList.length.toString();
                  }
                },
            onError: (error) {
              _isLoading = false;
        ...
        child: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              Divider(),
              _getDrawerItem(
                  2, getTranslated(context, "REQUESTS")!, Icons.person),
              Divider(),
    ...
    return Container(
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          } else if (title == getTranslated(context, "REQUESTS")!) {
            setState(
              () {
                curDrwSel = index;
              },
