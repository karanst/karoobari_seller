...
const Color primary =Color(0xff7c2525);
const Color secondary = Color(0xff7E2525);
const Color fontColor = Colors.black;
const Color grad1Color = Color(0xff7c2525);
const Color grad2Color = Color(0xff7c2525);
//const Color lightWhite2 = Color(0xffEEF2F3);

//const Color disableColor = Color(0xffEEF2F9);
const Color pink = Color(0xffD42727);
