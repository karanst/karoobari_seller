...
///Order Request Apis
final Uri getRequestsApi = Uri.parse(baseUrl + 'get_request_list');
final Uri getRequestDetailApi = Uri.parse(baseUrl + 'request_data');
final Uri updateRequestStatus = Uri.parse(baseUrl + 'update_order_status1');
